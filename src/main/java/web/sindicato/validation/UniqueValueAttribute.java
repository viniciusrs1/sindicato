package web.sindicato.validation;
...
import web.sindicato.validation.validator.UniqueValueAttributeValidator;
...
public @interface UniqueValueAttribute {
	...
	Class<? extends web.sindicato.validation.service.UniqueValue> service();
