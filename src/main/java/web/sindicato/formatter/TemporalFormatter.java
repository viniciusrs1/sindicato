package web.sindicato.formatter;
...
public abstract class TemporalFormatter<T extends Temporal> implements Formatter<T> {
	...
	private DateTimeFormatter getDateTimeFormatter(Locale locale) {
	    ...
	    DateTimeFormatter formatter = b.appendValue(ChronoField.YEAR_OF_ERA, 4, 4, SignStyle.EXCEEDS_PAD).appendPattern(padrao).toFormatter();
		return formatter;
	}
